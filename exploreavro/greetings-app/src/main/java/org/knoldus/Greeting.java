...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6887579277914186061L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"org.knoldus\",\"fields\":[{\"name\":\"greeting\",\"type\":\"string\"}]}");
   ...
   */
  public static org.knoldus.Greeting.Builder newBuilder() {
    return new org.knoldus.Greeting.Builder();
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static org.knoldus.Greeting.Builder newBuilder(org.knoldus.Greeting.Builder other) {
    if (other == null) {
      return new org.knoldus.Greeting.Builder();
    } else {
      return new org.knoldus.Greeting.Builder(other);
    }
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static org.knoldus.Greeting.Builder newBuilder(org.knoldus.Greeting other) {
    if (other == null) {
      return new org.knoldus.Greeting.Builder();
    } else {
      return new org.knoldus.Greeting.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.knoldus.Greeting.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.knoldus.Greeting other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.greeting)) {
        this.greeting = data().deepCopy(fields()[0].schema(), other.greeting);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.knoldus.Greeting.Builder setGreeting(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.knoldus.Greeting.Builder clearGreeting() {
      greeting = null;
