...
public class Store extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6633074143756161416L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Store\",\"namespace\":\"org.knoldus.domain.generated\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"address\",\"type\":{\"type\":\"record\",\"name\":\"Address\",\"fields\":[{\"name\":\"addressLine1\",\"type\":\"string\"},{\"name\":\"city\",\"type\":\"string\"},{\"name\":\"province\",\"type\":\"string\"},{\"name\":\"country\",\"type\":\"string\"},{\"name\":\"zip\",\"type\":\"string\"}]}}]}");
  ...
  @Deprecated public org.knoldus.domain.generated.Address address;
   ...
   */
  public Store(java.lang.Integer id, org.knoldus.domain.generated.Address address) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: address = (org.knoldus.domain.generated.Address)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public org.knoldus.domain.generated.Address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(org.knoldus.domain.generated.Address value) {
    this.address = value;
  }
   ...
   */
  public static org.knoldus.domain.generated.Store.Builder newBuilder() {
    return new org.knoldus.domain.generated.Store.Builder();
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static org.knoldus.domain.generated.Store.Builder newBuilder(org.knoldus.domain.generated.Store.Builder other) {
    if (other == null) {
      return new org.knoldus.domain.generated.Store.Builder();
    } else {
      return new org.knoldus.domain.generated.Store.Builder(other);
    }
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static org.knoldus.domain.generated.Store.Builder newBuilder(org.knoldus.domain.generated.Store other) {
    if (other == null) {
      return new org.knoldus.domain.generated.Store.Builder();
    } else {
      return new org.knoldus.domain.generated.Store.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Store>
    ...
    private int id;
    private org.knoldus.domain.generated.Address address;
    private org.knoldus.domain.generated.Address.Builder addressBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.knoldus.domain.generated.Store.Builder other) {
      super(other);
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = org.knoldus.domain.generated.Address.newBuilder(other.getAddressBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.knoldus.domain.generated.Store other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.knoldus.domain.generated.Store.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.knoldus.domain.generated.Store.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.knoldus.domain.generated.Store.Builder setAddress(org.knoldus.domain.generated.Address value) {
     ...
     * @return This builder.
     */
    public org.knoldus.domain.generated.Address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(org.knoldus.domain.generated.Address.newBuilder(address));
        } else {
          setAddressBuilder(org.knoldus.domain.generated.Address.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public org.knoldus.domain.generated.Store.Builder setAddressBuilder(org.knoldus.domain.generated.Address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public org.knoldus.domain.generated.Store.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    public Store build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[1] ? this.address : (org.knoldus.domain.generated.Address) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.address == null) {
        this.address = new org.knoldus.domain.generated.Address();
      }
